...
// more types
import type { AccountRecordSigners as AccountRecordSignersType } from "./account";
import type { AssetRecord as AssetRecordType } from "./assets";
import type * as Effects from "./effects";
import type { OfferRecord as OfferRecordType } from "./offer";
import type { Trade } from "./trade";

export namespace xlmAPI {
